...
const indexJS = programmingLanguage.charAt(0) + programmingLanguage.charAt(4)
console.log(indexJS)
const indexJs = programmingLanguage.replace('JavaScript', 'JS')
console.log(indexJs)
...
const newName = name[0].toUpperCase() + name.slice(1,6) + ' ' + name[7].toUpperCase() + name.slice(8,12)
console.log(newName);
...
- Exiba a "newName" no console;
*/
 const novoNome = `${name[0].toUpperCase()}${name.slice(1,6)}  ${name[7].toUpperCase()}${name.slice(8,12)}`
