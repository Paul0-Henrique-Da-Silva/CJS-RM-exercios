...
*/
const my3FavoriteTVShows = ['Game of Thrones', 'Stranger Things', 'Cavaleiro da Lua']
// const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows[my3FavoriteTVShows.length -3]}, ${my3FavoriteTVShows[my3FavoriteTVShows.length -2]} e ${my3FavoriteTVShows[my3FavoriteTVShows.length -1]}`
...
console.log(`A string que a "typeSentence" armazena tem mais de NÚMERO_DE_CARACTERES  
